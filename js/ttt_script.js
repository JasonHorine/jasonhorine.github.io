...
$(function(){
  ...
  pointerControl(1);
  // if a cell is clicked, call clickCell()
  $('#cell0').click(clickCell(0));
  $('#cell1').click(clickCell(1));
  $('#cell2').click(clickCell(2));
  $('#cell3').click(clickCell(3));
  $('#cell4').click(clickCell(4));
  $('#cell5').click(clickCell(5));
  $('#cell6').click(clickCell(6));
  $('#cell7').click(clickCell(7));
  $('#cell8').click(clickCell(8));

  //if reset is clicked:
  $('#reset-btn').click(resetBoard());
});
